...
#
# Usage example:
# python compare_diff_stage2_restoration.py \
#     --base_path /path/to/stage1_stackmffv4_stage2_diff_restoration \
#     --methods GKMNet IFAN DRBNet Restormer LaKDNet INIKNet NRKNet DEDDNet GMFF \
...
def parse_args():
    ...
    parser.add_argument('--base_path', type=str, default=r'/media/user/68fdd01e-c642-4deb-9661-23b76592afb1/xxz/project_image_stack_fusion/GMFF/compare_dir',
                        help='Base path containing the result images for different methods')
    parser.add_argument('--methods', type=str, nargs='+', default=['GMFF'],
                        help='List of methods to compare')
    # parser.add_argument('--methods', type=str, nargs='+', default=['GKMNet', 'IFAN', 'DRBNet', 'Restormer', 'LaKDNet', 'INIKNet', 'NRKNet', 'DEDDNet', 'GMFF'],
    #                     help='List of methods to compare')
...
def calculate_pyiqa_metric(img, metric_model):
    ...
    # Convert to float and normalize to [0, 1], format: [H, W, C]
